...
Editor Form state, and E.5.5 now accepts temporary JSON/mapping preparation
without Preview execution. E.5.6 next binds Published Preview. Imported values remain
