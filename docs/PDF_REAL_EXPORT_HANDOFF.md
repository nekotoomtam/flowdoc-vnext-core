...
explicit unavailable scalar constraints. `PDF-EXPORT-REALDOC-E.5.4` accepts
...
corruption rejection. E.6.2 accepts durable operation/lifecycle/artifact
restart and verified 10-page recovery after a post-render fault. E.6.3 now
accepts explicit known-operation resume, strict content-free Editor reconnect,
cancel reconciliation, stale-result rejection, diagnostics, and download.
Complete E.6 is accepted for the optional local profile.
