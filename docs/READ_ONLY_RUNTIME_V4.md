...
the separate backend-owned delete/duplicate/reorder paths; the read session
does not mutate its package.
...
- Text editing and direct session mutation remain closed.

## FAIL / BLOCKER

- Only the separate generic block lifecycle kernel exists.
