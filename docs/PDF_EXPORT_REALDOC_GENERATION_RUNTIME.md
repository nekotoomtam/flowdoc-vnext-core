...
`PDF-EXPORT-REALDOC-E.5.0` now locks the Editor workspace product contract.
Next: `PDF-EXPORT-REALDOC-E.5.1` bounded local Document Library read model and
first Library view. Production remains NO-GO.
