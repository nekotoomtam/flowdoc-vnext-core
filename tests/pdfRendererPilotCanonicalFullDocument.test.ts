    ...
    expect(SUMMARY).toMatchObject({
      ...
      artifact: {
        ...
        fullDocumentHandoff: {
          ...
          imagePaintCount: 5,
          strokeLineCount: 696,
          sourceContractContentSha256: "17bec29d5833e3c9ab61c63746f1de0cf008fb0259c8f0620776879d3edf7826",
        },
      },
      renderContract: {
  ...
  it("verifies page tree, embedded resources, text extraction, and line paths with an external parser", () => {
    expect(QA).toMatchObject({
      ...
      contentStreamInspection: {
        ...
        expectedGlyphRunCount: 978,
        expectedStrokeLineCount: 696,
        expectedImagePaintCount: 5,
      },
      textExtraction: {
        engine: "pypdf",
        expectedGlyphRuns: 978,
        whitespaceNormalizedRunPresence: 978,
