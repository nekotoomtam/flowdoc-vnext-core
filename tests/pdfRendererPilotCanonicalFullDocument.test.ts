    ...
    expect(SUMMARY).toMatchObject({
      ...
      artifact: {
        ...
        fullDocumentHandoff: {
          ...
          imagePaintCount: 5,
          strokeLineCount: 675,
          sourceContractContentSha256: "37481597e139c52e30d0eea4b413264ed06d666bcaa8fbf0bdcd5d3cf44a4b29",
        },
      },
      renderContract: {
  ...
  it("verifies page tree, embedded resources, text extraction, and line paths with an external parser", () => {
    expect(QA).toMatchObject({
      ...
      contentStreamInspection: {
        ...
        expectedGlyphRunCount: 1018,
        expectedStrokeLineCount: 675,
        expectedImagePaintCount: 5,
      },
      textExtraction: {
        engine: "pypdf",
        expectedGlyphRuns: 1018,
        whitespaceNormalizedRunPresence: 1018,
