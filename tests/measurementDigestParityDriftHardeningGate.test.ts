...
describe("measurement digest parity drift hardening gate", () => {
  ...
  it("advances current pointers to the v1 fixture evidence matrix gate", () => {
    ...
    expect(currentStatus).toContain("Status: updated after Phase 183.")
    ...
    expect(nextPointer).toContain("Status: current after Phase 183.")
    expect(nextPointer).toContain("Phase 184: V1 Measurement Fixture Evidence Matrix Gate.")
    expect(nextPointer).toContain("v1 measurement fixture/scenario evidence matrix")
  ...
  it("documents Phase 183 in the README, roadmap, and ledger", () => {
    ...
    expect(roadmap).toContain("Current next step after Phase 183:")
