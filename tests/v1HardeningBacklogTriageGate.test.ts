...
describe("v1 hardening backlog triage gate", () => {
  ...
  it("advances current pointers to the measurement hardening gate", () => {
    ...
    expect(currentStatus).toContain("Status: updated after Phase 182.")
    expect(currentStatus).toContain("Phase 182: V1 Hardening Backlog Triage Gate.")
    expect(currentStatus).toContain("Phase 183: Measurement Digest Parity Drift Hardening Gate.")
    ...
    expect(nextPointer).toContain("Status: current after Phase 182.")
    expect(nextPointer).toContain("Phase 183: Measurement Digest Parity Drift Hardening Gate.")
    expect(nextPointer).toContain("measurement digest/parity/drift hardening gate")
  ...
  it("documents Phase 182 in the README, roadmap, and ledger", () => {
    ...
    expect(roadmap).toContain("Current next step after Phase 182:")
