    ...
    expect(result).toMatchObject({
      ...
      persistentFlowUpdate: {
        ...
        work: {
          ...
          reusedNodeCount: 2,
          createdNodeCount: 3,
          createdNodeCanonicalByteCount: 396_752,
          rangeLookupVisitedNodeCount: 4,
          pathCopyVisitedNodeCount: 4,
          previousSuffixCheckpointFoldLineCount: 0,
        },
      },
      affectedWindow: {
        work: {
    ...
    const cases = [
      {
        ...
        evidence: {
          ...
          reusedNodeCount: 2,
          createdNodeCount: 3,
          createdNodeCanonicalByteCount: 424_002,
          assembledAffectedLineCount: 2,
      ...
      },
      {
        ...
        evidence: {
          ...
          reusedNodeCount: 2,
          createdNodeCount: 2,
          createdNodeCanonicalByteCount: 395_730,
      ...
      },
      {
        ...
        evidence: {
          ...
          reusedNodeCount: 2,
          createdNodeCount: 3,
          createdNodeCanonicalByteCount: 396_174,
          assembledAffectedLineCount: 2,
          previousReconvergenceLineIndex: 63,
          nextReconvergenceLineIndex: 63,
          previousReconvergenceOffset: 2_472,
