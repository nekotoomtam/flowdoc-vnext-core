...
describe("layout unit policy v1", () => {
  ...
  it("documents the MR1 boundary without claiming multi-run or production activation", () => {
    ...
    expect(handoff).toMatch(/Multi-run\s+shaping and paint geometry remain blocked/)
  })
})
