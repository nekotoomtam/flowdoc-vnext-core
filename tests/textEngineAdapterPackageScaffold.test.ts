...
describe("vNext text engine adapter package scaffold", () => {
  ...
  it("documents the external adapter package scaffold in the phase trail", () => {
    ...
    expect(packageReadme).toContain("Status: Phase 113 rustybuzz native smoke package.")
    expect(packageReadme).toContain("TypeScript adapter evidence")
    expect(packageReadme).toContain("mocked")
