...
describe("PDF-EXPORT-REALDOC-E.0 DocGen architecture lock", () => {
  ...
  it("updates the retained roadmap and phase trail without activating production", () => {
    ...
    expect(roadmap).toContain("### REALDOC-E.5.1 Local Document Library (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.2 Shared Workspace Tabs (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.3 Core Test-Input Projection (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.4 Temporary Generated Form (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.5 Temporary JSON And Mapping Preparation (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.6 Published Preview Binding (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.7 Draft Preview Binding (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.8 Preview Lifecycle UX (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.5.9 Form/API Parity (Accepted)")
    expect(roadmap).toContain("### REALDOC-E.6 Cross-Repo Lifecycle Acceptance")
    ...
    expect(map).toContain("PDF export REALDOC-E.5.1 accepts the bounded local Backend Library query")
    expect(map).toContain("PDF export REALDOC-E.5.2 accepts one document-keyed Editor runtime")
    expect(map).toContain("PDF export REALDOC-E.5.3 accepts one pure Core test-input projection")
    expect(map).toContain("PDF export REALDOC-E.5.4 accepts Editor-owned memory-only Form state")
    expect(map).toContain("PDF export REALDOC-E.5.5 accepts Editor-owned memory-only JSON text")
    expect(map).toContain("PDF export REALDOC-E.5.6 accepts a value-free Backend Published Preview")
    expect(map).toContain("PDF export REALDOC-E.5.8 accepts complete local Preview lifecycle recovery")
    expect(map).toContain("PDF export REALDOC-E.5.9 accepts direct Form and adapted API convergence")
    ...
    expect(ledger).toContain("## PDF-EXPORT-REALDOC-E.5.1 Local Document Library")
    expect(ledger).toContain("## PDF-EXPORT-REALDOC-E.5.2 Shared Workspace Tabs")
    ...
    expect(ledger).toContain("## PDF-EXPORT-REALDOC-E.5.5 Temporary JSON And Mapping Preparation")
    expect(ledger).toContain("## PDF-EXPORT-REALDOC-E.5.6 Published Preview Binding")
    expect(ledger).toContain("## PDF-EXPORT-REALDOC-E.5.8 Preview Lifecycle UX")
    expect(ledger).toContain("## PDF-EXPORT-REALDOC-E.5.9 Form/API Parity")
