...
export function createTemplateBuilderSnapshot(
  ...
  return {
    ...
    actionLanes: [
      ...
      {
        action: "browser.runStructuralDiagnosticsNavigation",
        label: "Diagnostics nav",
        lane: "immediate",
        status: "wired",
        reason: "browser diagnostics navigation can jump node-linked issues through the same node-aware selection path",
      },
      {
      ...
      {
        action: "browser.trackViewportAnchor",
      ...
      {
        action: "browser.restoreViewportNodeAnchor",
        label: "Node anchor",
        lane: "immediate",
        status: "wired",
        reason: "browser canvas can restore selection jumps from node-aware viewport anchors",
      },
      {
      ...
      {
        action: "browser.planViewportCandidate",
        label: "Viewport candidate",
        lane: "immediate",
        status: "wired",
      ...
      {
        action: "browser.runViewportSchedulerRuntime",
      ...
      {
        action: "browser.hardenContenteditableSurface",
        label: "Surface hardening",
        lane: "immediate",
        status: "wired",
        reason: "browser-local production contenteditable surface hardening resolves nested selection facts and drift guards before package mutation",
      },
      {
      ...
      {
        action: "browser.normalizeDraftRichInlineState",
        label: "Rich state",
        lane: "immediate",
        status: "wired",
      ...
      {
        action: "sandbox.replayRichInlineHistory",
        label: "Rich replay",
        lane: "commit",
        status: "wired",
        reason: "sandbox undo/redo replays rich inline commit patches through the vNext-native rich inline replacement boundary",
      },
      {
        action: "sandbox.planRichInlineSessionPersistence",
        label: "Rich session",
        lane: "commit",
        status: "wired",
        reason: "core rich inline session persistence records can bind package snapshots, durable history, and replay patches before storage writes",
      },
      {
