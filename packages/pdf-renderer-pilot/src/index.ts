...
const FULL_DOCUMENT_HANDOFF = {
  ...
  contractFingerprint: "sha256:020881c6099d8eec5e73d5558efa0c0d65de67599aa99e82f8cbf9d62e4e6917",
  contractContentSha256: "5f28958947715a3a9bdc006a73688bf8226f782047db5f5c53ffe0349dbd8b78",
  pageCount: 13,
  fontAssetCount: 2,
  imageAssetCount: 5,
} as const
...
function prepareFlowDocPdfPilot(
  ...
  if (input.artifactId != null && input.artifactId.trim().length === 0) {
    issues.push(issue("invalid-artifact-id", "artifactId", `${phaseId} requires a non-blank artifact id when supplied.`))
  }
